...
from data_loader import train_generate, with_k
...
class Trainer(object):
    def __init__(self, arg):
        ...
        self.rel2candidates = json.load(
            open(self.dataset + "/rel2candidates_all_ent.json")
        )
    ...
    def load_embed(self):
        symbol_id = {}
        rel2id = json.load(
            open(self.dataset + "/rel2ids_shuffle")
        ...
        for query_ in test_tasks.keys():
            ...
            for triple in test_tasks[query_][few:]:
                ...
                for ent in candidates:
                    if (
                        ent not in self.e1rel_e2[triple[0] + triple[1]]
                    ) and ent != true:
